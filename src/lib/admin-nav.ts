...
export const ADMIN_NAV: AdminNavItem[] = [
  { href: '/admin', label: 'Dashboard', icon: LayoutDashboard, roles: ['operations_manager', 'finance_officer', 'booking_officer', 'customer_support', 'content_editor', 'ticket_inspector'] },
